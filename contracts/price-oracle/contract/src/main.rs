...
use common_lib::constants::{ARG_PO_EXTENSION, ENDPOINT_PO_INIT, ENDPOINT_PO_PRICE_GET_SIMPLE_OPERATIONS, ENDPOINT_PO_PRICE_SET_SIMPLE_OPERATIONS, KEY_PO_SIMPLE_OPERATIONS};
...
pub extern "C" fn call() {
    ...
    price_oracle_named_keys.insert(KEY_PO_SIMPLE_OPERATIONS.to_string(), price_oracle_price_simple_operations.into());

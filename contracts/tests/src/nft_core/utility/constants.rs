pub(crate) const NFT_CONTRACT_WASM: &str = "nft-core-contract.wasm";
...
pub(crate) const CONTRACT_NAME: &str = "cep78_contract_hash_casper-names-test";
pub(crate) const MINTING_CONTRACT_NAME: &str = "minting_contract_hash";
pub(crate) const NFT_TEST_TOKEN_SUPPLY: u64 = 50_000u64;
pub(crate) const NFT_TEST_COLLECTION: &str = "casper-names-test";
pub(crate) const NFT_TEST_SYMBOL: &str = "CSPR";

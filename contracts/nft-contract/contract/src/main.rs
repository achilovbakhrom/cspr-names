...
use casper_types::{
    ...
    EntryPointType, EntryPoints, Key, Parameter, U512,
};
...
use common_lib::constants::common_keys::{
    ...
    ENDPOINT_NFT_BUY, ENDPOINT_NFT_INITIALIZE, ENDPOINT_NFT_LIST, ENDPOINT_NFT_MINT,
    ENDPOINT_NFT_SET_CURRENT_CONTRACT_HASH, ENDPOINT_NFT_SET_NFT_CONTRACT_HASH,
    ENDPOINT_NFT_TRANSFER, ENDPOINT_NFT_UN_LIST, KEY_NFT_CONTRACT_ACCESS_UREF,
    KEY_NFT_CONTRACT_HASH, KEY_NFT_CONTRACT_OWNER, KEY_NFT_CONTRACT_PACKAGE_NAME,
    KEY_NFT_CONTRACT_VERSION,
};
...
pub extern "C" fn buy() {
    let token_id = runtime::get_named_arg::<String>(ARG_TOKEN_ID);
    let instance = ListingDb::instance();

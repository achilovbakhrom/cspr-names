...
pub extern "C" fn register_domain() {
	...
	response_success(saving_domain_name, "Error while converting value to CL_Value");
}
...
pub extern "C" fn init() {
	...
	upsert_dictionary_value_from_key::<Vec<String>>(KEY_DATABASE_DICTIONARY_DOMAIN_LIST, "0", vec![]);
...
pub extern "C" fn call() {
	...
	entrypoints.add_entry_point(
		EntryPoint::new(
			ENTRYPOINT_MAIN_SET_AUTHORITIES_CONTRACT_HASH,
			vec![Parameter::new(ARG_MAIN_PRICE_ORACLE_CONTRACT_HASH, ContractHash::cl_type())],
			CLType::Unit,
